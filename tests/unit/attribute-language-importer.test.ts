...
import { applySkillProficiencies, applyLanguages, applyAttributeBoosts } from "../../src/import/attribute-language-importer.js";
...
describe("applySkillProficiencies", () => {
  ...
  it("sets skill ranks from increase engines", async () => {
    ...
    const engines: DemiplaneEngineEntry[] = [
      { id: "1", name: "core/selection/skill/increase/index.eng", type: "DemiplaneEngine", args: { slug: "athletics", sourceRow: "skill-training-fighter-rm" } },
      { id: "2", name: "core/selection/skill/increase/index.eng", type: "DemiplaneEngine", args: { slug: "crafting", sourceRow: "skill-training-fighter-rm" } },
    ];
  ...
  it("sets expert rank for skill-increase sourceRow", async () => {
    ...
    const engines: DemiplaneEngineEntry[] = [
      { id: "1", name: "core/selection/skill/increase/index.eng", type: "DemiplaneEngine", args: { slug: "athletics", sourceRow: "skill-increase-level-3-rm" } },
    ];
    const summary = makeSummary();
    await applySkillProficiencies(actor as never, engines, summary);
  ...
  it("applies overrides when --overridden flag is set", async () => {
    ...
    const engines: DemiplaneEngineEntry[] = [
      { id: "1", name: "core/selection/skill/increase/index.eng", type: "DemiplaneEngine", args: { slug: "survival", sourceRow: "skill-training-fighter-rm" } },
      { id: "2", name: "character_survival_prof", type: "CustomDemiplaneEngine", args: {}, value: 0 },
      { id: "3", name: "character_survival_prof--overridden", type: "CustomDemiplaneEngine", args: {}, value: 1 },
    ];
    const summary = makeSummary();
    await applySkillProficiencies(actor as never, engines, summary);
...
describe("applyLanguages", () => {
  beforeEach(() => {
    installFoundryMocks();
    (globalThis as unknown as { CONFIG: { PF2E: { languages: Record<string, string> } } }).CONFIG = {
      PF2E: { languages: { common: "Common", draconic: "Draconic", elven: "Elven" } },
    };
  });
  ...
  it("adds valid languages", async () => {
    const actor = createMockActor();
    const engines: DemiplaneEngineEntry[] = [
      { id: "1", name: "character-languages-user", type: "CustomDemiplaneEngine", args: {}, value: "Draconic, Elven" },
    ];
    const summary = makeSummary();
  ...
  it("reports unmatched languages", async () => {
    const actor = createMockActor();
    const engines: DemiplaneEngineEntry[] = [
      { id: "1", name: "character-languages-user", type: "CustomDemiplaneEngine", args: {}, value: "Draconic, Klingon" },
    ];
    const summary = makeSummary();
    await applyLanguages(actor as never, engines, summary);
  ...
  it("splits on newlines", async () => {
    const actor = createMockActor();
    const engines: DemiplaneEngineEntry[] = [
      { id: "1", name: "character-languages-user", type: "CustomDemiplaneEngine", args: {}, value: "Draconic\nElven" },
    ];
    const summary = makeSummary();
    await applyLanguages(actor as never, engines, summary);
...
describe("applyAttributeBoosts", () => {
  ...
  it("applies ancestry boosts", async () => {
    ...
    const engines: DemiplaneEngineEntry[] = [
      { id: "1", name: "core/selection/attribute/boost.eng", type: "DemiplaneEngine", args: { slug: "strength", sourceRow: "ancestry-boosts" } },
      { id: "2", name: "core/selection/attribute/boost.eng", type: "DemiplaneEngine", args: { slug: "dexterity", sourceRow: "ancestry-boosts" } },
    ];
    const summary = makeSummary();
  ...
  it("applies level boosts to actor", async () => {
    const actor = createMockActor();
    const engines: DemiplaneEngineEntry[] = [
      { id: "1", name: "core/selection/attribute/boost.eng", type: "DemiplaneEngine", args: { slug: "strength", sourceRow: "attribute-boosts-level-1-rm" } },
      { id: "2", name: "core/selection/attribute/boost.eng", type: "DemiplaneEngine", args: { slug: "constitution", sourceRow: "attribute-boosts-level-1-rm" } },
    ];
    const summary = makeSummary();
    await applyAttributeBoosts(actor as never, engines, summary);
